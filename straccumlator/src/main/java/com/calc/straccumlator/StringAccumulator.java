...
public class StringAccumulator {
	...
	public static final String[] SPECIALCHARCARTERSSTR = { ".", "*", "+", "=", "-", "?", "^", "$" };
	public static final List<String> SPECIALCHARCARTERSList = Arrays.asList(SPECIALCHARCARTERSSTR);
	...
	private String addEscapeForSpecialCharacter(String str, char ch) {
		if (!SPECIALCHARCARTERSList.contains("" + ch)) {
			return str;
		}
